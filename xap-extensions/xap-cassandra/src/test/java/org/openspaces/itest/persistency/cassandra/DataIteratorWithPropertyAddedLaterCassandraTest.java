...
public class DataIteratorWithPropertyAddedLaterCassandraTest extends AbstractCassandraTest {
    ...
    public void test() {
        ...
        Assert.assertEquals("Wrong value", Integer.valueOf(1), doc.getProperty(keyName));
        Assert.assertEquals("Wrong value", Boolean.TRUE, doc.getProperty("some_prop"));
...
//        Assert.assertEquals("Wrong value", newType.getStr(), ((SpaceDocument)doc.getProperty("new_prop")).getProperty("str"));
        ...
        Assert.assertEquals("Wrong value", Integer.valueOf(2), doc.getProperty("new_prop2"));
